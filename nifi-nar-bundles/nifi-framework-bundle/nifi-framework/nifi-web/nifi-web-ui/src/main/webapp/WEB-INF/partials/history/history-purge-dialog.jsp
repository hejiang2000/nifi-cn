        ...
        <div class="setting" style="margin-bottom: 0px;">
            <div class="end-date-setting">
                <div class="setting-name">
                    结束日期
                    <div class="fa fa-question-circle" alt="Info" title="清理结束日期格式为 'mm/dd/yyyy'. 你必须同时指定结束时间."></div>
                </div>
            ...
            <div class="end-time-setting">
                <div class="setting-name">
                    ...
                    <div class="fa fa-question-circle" id="purge-end-time-info" alt="Info" title="结束时间格式为 'hh:mm:ss'. 你必须同时指定结束日期."></div>
                </div>
                <div class="setting-field">
