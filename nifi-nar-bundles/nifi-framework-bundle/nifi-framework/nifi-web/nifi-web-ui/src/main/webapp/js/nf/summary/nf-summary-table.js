    ...
    var initSummaryTable = function (isClustered) {
        ...
        var processGroupsColumnModel = [
            ...
            receivedColumn,
         {
            id: 'activeThreads',
            field: 'activeThreads',
            name: '<span class="thread-count-title">活动线程数</span>&nbsp;(<span class="thread-count-percentage-title">%</span>)&nbsp;<span style="font-weight: normal; overflow: hidden;">5 分钟</span>',
        ...
        },
       {
            id: 'taskDuration',
            field: 'taskDuration',
            name: '<span class="duration-title">任务总时间</span>&nbsp;(<span class="duration-percentage-title">%</span>)&nbsp;<span style="font-weight: normal; overflow: hidden;">5 分钟</span>',
